        ...
        <div class="col-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Add New Test</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.tests.store') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('category') is-invalid @enderror" id="category" name="category" required>
                                    ...
                                    <option value="blood" {{ old('category') == 'blood' ? 'selected' : '' }}>Blood Test</option>
                                    <option value="urine" {{ old('category') == 'urine' ? 'selected' : '' }}>Urine Test</option>
                                    <option value="stool" {{ old('category') == 'stool' ? 'selected' : '' }}>Stool Test</option>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('result_type') is-invalid @enderror" id="result_type" name="result_type" required>
                                    ...
                                    <option value="file" {{ old('result_type') == 'file' ? 'selected' : '' }}>File</option>
                                </select>
                                @error('result_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <small class="form-text text-muted">Enter minimum and maximum values for the normal range (leave empty for non-numeric tests)</small>
                            </div>
