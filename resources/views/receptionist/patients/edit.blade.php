        ...
        <div class="card-body">
            <form action="{{ route('receptionist.patients.update', $patient) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', $patient->email) }}" required>
                            @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="emergency_contact" id="emergency_contact" class="form-control @error('emergency_contact') is-invalid @enderror" value="{{ old('emergency_contact', $patient->emergency_contact) }}" required>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" name="date_of_birth" id="date_of_birth" class="form-control @error('date_of_birth') is-invalid @enderror" value="{{ old('date_of_birth', $patient->date_of_birth) }}" required>
                            @error('date_of_birth')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="address" id="address" class="form-control @error('address') is-invalid @enderror" rows="3" required>{{ old('address', $patient->address) }}</textarea>
                    @error('address')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                        ...
                        @foreach(['Diabetes', 'Hypertension', 'Heart Disease', 'Asthma', 'Cancer', 'Other'] as $condition)
                            <div class="col-md-4">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="medical_history_{{ strtolower(str_replace(' ', '_', $condition)) }}" name="medical_history[]" value="{{ $condition }}" {{ in_array($condition, old('medical_history', $patient->medical_history ?? [])) ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        @foreach(['Penicillin', 'Sulfa', 'Aspirin', 'Latex', 'Food', 'Other'] as $allergy)
                            <div class="col-md-4">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="allergies_{{ strtolower(str_replace(' ', '_', $allergy)) }}" name="allergies[]" value="{{ $allergy }}" {{ in_array($allergy, old('allergies', $patient->allergies ?? [])) ? 'checked' : '' }}>
